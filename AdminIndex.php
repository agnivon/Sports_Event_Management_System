  ...
  <div class="row m-0">
    <div class="col-md-6">
      <div class="text-center pb-5">
          ...
          <p class="p-1 m-0 font-ubuntu text-black-50">View & Modify the DataBase</p>
      </div>
      <div class="d-flex justify-content-center">
        <div class="form-row">
          <div class="col">
            <form action="Edit-Athlete.php" enctype="multipart/form-data" id="ViewAthlete">
      ...
      <div class="col">
        <form action="Edit-Event.php" enctype="multipart/form-data" id="ViewEvent">
         <div class="submit-btn text-center my-5">
       ...
       <div class="col">
         <form action="Edit-Result.php" enctype="multipart/form-data" id="ViewResult">
          <div class="submit-btn text-center my-5">
        ...
        <div class="col">
          <form action="Edit-Sponsorer.php" enctype="multipart/form-data" id="ViewSponsorers">
           <div class="submit-btn text-center my-5">
         ...
         <div class="col">
           <form action="Edit-Country.php" enctype="multipart/form-data" id="ViewCountry">
            <div class="submit-btn text-center my-5">
          ...
          <div class="col">
            <form action="AdminRecord.php" enctype="multipart/form-data" id="ViewSponsorers">
             <div class="submit-btn text-center my-5">
