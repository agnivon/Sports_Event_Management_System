...
<head>
  ...
  <body>
    ...
    <table class="table table-striped table-hover table-active align-middle;">
      <tr>
        ...
        if($total!=0){
          ...
          <tr>
            ...
            <td><a href= 'deleteResult.php?rn=$result[Result_Id]'>Delete</a></td>
            <td><a href= 'UpdateResult.php?ri=$result[Result_Id]&ei=$result[Event_Id]&en=$result[Event_Name]&
            ai=$result[Athlete_Id]&mt=$result[Medal_Type]&tt=$result[Total_Time]'>Edit</a></td>
          </tr>
          ";
          }
        }
      ...
      <form action="NewResult.php" enctype="multipart/form-data" >
